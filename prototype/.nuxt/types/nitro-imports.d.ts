declare global {
  ...
  const assignments: typeof import('../../server/utils/store').assignments
  const auditLogs: typeof import('../../server/utils/store').auditLogs
  ...
  const evaluateAnomalies: typeof import('../../server/utils/anomalies').evaluateAnomalies
  const eventHandler: typeof import('../../node_modules/h3').eventHandler
  const fetchWithEvent: typeof import('../../node_modules/h3').fetchWithEvent
  const fromNodeMiddleware: typeof import('../../node_modules/h3').fromNodeMiddleware
  const fromPlainHandler: typeof import('../../node_modules/h3').fromPlainHandler
  const fromWebHandler: typeof import('../../node_modules/h3').fromWebHandler
  const getAuditForEntity: typeof import('../../server/utils/audit').getAuditForEntity
  ...
  const issues: typeof import('../../server/utils/store').issues
  const lazyEventHandler: typeof import('../../node_modules/h3').lazyEventHandler
  const locations: typeof import('../../server/utils/store').locations
  const nextId: typeof import('../../server/utils/store').nextId
  ...
  const shifts: typeof import('../../server/utils/store').shifts
  const simulateTick: typeof import('../../server/utils/store').simulateTick
  const splitCookiesString: typeof import('../../node_modules/h3').splitCookiesString
  const tickCount: typeof import('../../server/utils/store').tickCount
  const toEventHandler: typeof import('../../node_modules/h3').toEventHandler
  const toNodeListener: typeof import('../../node_modules/h3').toNodeListener
  const toPlainHandler: typeof import('../../node_modules/h3').toPlainHandler
  const toWebHandler: typeof import('../../node_modules/h3').toWebHandler
  const toWebRequest: typeof import('../../node_modules/h3').toWebRequest
  const transitionIssue: typeof import('../../server/utils/anomalies').transitionIssue
  const trips: typeof import('../../server/utils/store').trips
  const units: typeof import('../../server/utils/store').units
  ...
  const writeAudit: typeof import('../../server/utils/audit').writeAudit
...
declare global {
  ...
  // @ts-ignore
  export type { AuditInput } from '../../server/utils/audit'
  import('../../server/utils/audit')
  // @ts-ignore
  export type { UnitType, Ownership, TonnageStatus, AssignmentStatus, IssueSeverity, IssueStatus, Unit, Location, Shift, TonnageHistory, Trip, Assignment, Issue, AuditLog } from '../../server/utils/store'
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/Users/raissagabriella/Documents/projects/FMS PTBA/prototype/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/Users/raissagabriella/Documents/projects/FMS PTBA/prototype/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { evaluateAnomalies, transitionIssue } from '/Users/raissagabriella/Documents/projects/FMS PTBA/prototype/server/utils/anomalies';
export { writeAudit, getAuditForEntity } from '/Users/raissagabriella/Documents/projects/FMS PTBA/prototype/server/utils/audit';
export { units, locations, shifts, trips, assignments, issues, auditLogs, nextId, tickCount, simulateTick } from '/Users/raissagabriella/Documents/projects/FMS PTBA/prototype/server/utils/store';