  ...
  <UDashboardPanel id="production">
    <template #header>
      <div class="flex items-center justify-between w-full flex-wrap gap-2">
        <div>
          <h1 class="text-xl font-bold">Production</h1>
          <p class="text-xs text-(--ui-text-muted)">Trip ritase, tonnage tracking and manual entry</p>
        </div>
    ...
    <template #body>
      <!-- KPI Cards -->
      <div class="grid grid-cols-[repeat(auto-fit,minmax(180px,1fr))] gap-4 mb-6" v-if="kpis">
      ...
      <div v-else class="grid grid-cols-[repeat(auto-fit,minmax(180px,1fr))] gap-4 mb-6">
